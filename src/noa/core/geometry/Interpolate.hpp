...
namespace noa::geometry::interpolate::details {
    ...
    constexpr bool is_valid_interp_v = traits::is_real_or_complex_v<data_t> && traits::is_real_v<coord_t>;
    ...
    constexpr NOA_IHD void bspline_weights(coord_t ratio, data_t* w0, data_t* w1, data_t* w2, data_t* w3) {
...
namespace noa::geometry::interpolate {
    ...
    constexpr NOA_FHD data_t lerp_1d(data_t v0, data_t v1, coord_t r) noexcept {
        using value_t = traits::value_type_t<data_t>;
        return static_cast<value_t>(r) * (v1 - v0) + v0;
    }

    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_FHD data_t lerp_2d(data_t v00, data_t v01, data_t v10, data_t v11, coord_t rx, coord_t ry) noexcept {
        const data_t tmp1 = lerp_1d(v00, v01, rx);
        const data_t tmp2 = lerp_1d(v10, v11, rx);
        return lerp_1d(tmp1, tmp2, ry); // https://godbolt.org/z/eGcThbaGG
    }

    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_FHD data_t lerp_3d(data_t v000, data_t v001, data_t v010, data_t v011,
                                     data_t v100, data_t v101, data_t v110, data_t v111,
                                     coord_t rx, coord_t ry, coord_t rz) noexcept {
        const data_t tmp1 = lerp_2d(v000, v001, v010, v011, rx, ry);
        const data_t tmp2 = lerp_2d(v100, v101, v110, v111, rx, ry);
...
namespace noa::geometry::interpolate {
    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_IHD data_t cosine_1d(data_t v0, data_t v1, coord_t r) {
        constexpr coord_t PI = ::noa::math::Constant<coord_t>::PI;
        const coord_t tmp = (static_cast<coord_t>(1) - ::noa::math::cos(r * PI)) / static_cast<coord_t>(2);
        return lerp_1d(v0, v1, tmp);
    }

    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_IHD data_t cosine_2d(data_t v00, data_t v01, data_t v10, data_t v11, coord_t rx, coord_t ry) {
        constexpr coord_t PI = ::noa::math::Constant<coord_t>::PI;
    ...
    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_IHD data_t cosine_3d(data_t v000, data_t v001, data_t v010, data_t v011,
                                       data_t v100, data_t v101, data_t v110, data_t v111,
...
namespace noa::geometry::interpolate {
    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_HD data_t cubic_1d(data_t v0, data_t v1, data_t v2, data_t v3, coord_t r) {
    ...
    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_HD data_t cubic_2d(data_t v[4][4], coord_t rx, coord_t ry) {
        const data_t a0 = cubic_1d(v[0][0], v[0][1], v[0][2], v[0][3], rx);
        const data_t a1 = cubic_1d(v[1][0], v[1][1], v[1][2], v[1][3], rx);
        const data_t a2 = cubic_1d(v[2][0], v[2][1], v[2][2], v[2][3], rx);
        const data_t a3 = cubic_1d(v[3][0], v[3][1], v[3][2], v[3][3], rx);
        return cubic_1d(a0, a1, a2, a3, ry);
    }

    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_HD data_t cubic_3d(data_t v[4][4][4], coord_t rx, coord_t ry, coord_t rz) {
        const data_t a0 = cubic_2d(v[0], rx, ry);
        const data_t a1 = cubic_2d(v[1], rx, ry);
        const data_t a2 = cubic_2d(v[2], rx, ry);
        const data_t a3 = cubic_2d(v[3], rx, ry);
...
namespace noa::geometry::interpolate {
    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_IHD data_t cubic_bspline_1d(data_t v0, data_t v1, data_t v2, data_t v3, coord_t r) {
        using real_t = traits::value_type_t<data_t>;
        real_t w0, w1, w2, w3;
    ...
    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_HD data_t cubic_bspline_2d(data_t v[4][4], coord_t rx, coord_t ry) {
        using real_t = traits::value_type_t<data_t>;
        real_t w0, w1, w2, w3;
    ...
    template<typename data_t, typename coord_t, typename = details::enable_if_valid_interp_t<data_t, coord_t>>
    constexpr NOA_HD data_t cubic_bspline_3d(data_t v[4][4][4], coord_t rx, coord_t ry, coord_t rz) {
        using real_t = traits::value_type_t<data_t>;
