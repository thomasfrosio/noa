...
namespace noa::geometry {
    ...
    template<BorderMode BORDER_MODE, InterpMode INTERP_MODE,
             typename Data, typename Index = i64, typename Coord = f32>
    ...
    public:
        ...
        using shape2_type = Shape2<coord_type>;
    ...
    public:
        ...
        constexpr NOA_HD InterpolatorValue2D(
                data_type data, shape2_type shape,
...
namespace noa::geometry {
    ...
    template<BorderMode BORDER_MODE, InterpMode INTERP_MODE,
             typename Data, typename Index = i64, typename Coord = f64>
    ...
    public:
        ...
        using shape3_type = Shape3<coord_type>;
        using data_or_empty_type = std::conditional_t<BORDER_MODE == BorderMode::VALUE, data_type, traits::Empty>;
    ...
    public:
        ...
        constexpr NOA_HD InterpolatorValue3D(
                data_type data, shape3_type shape,
                data_type cvalue = data_type{0}) noexcept
                : m_data(data), m_shape(shape.vec()) {
            if constexpr (!std::is_empty_v<data_or_empty_type>)
                m_cvalue = cvalue;
