...
namespace noa::cpu::fft {
    ...
    void r2c(
        ...
        const Shape4& shape, u32 flag, bool plan_only, isize n_threads
    ) {
    ...
    template<typename T>
    void r2c(T* data, const Strides4& strides, const Shape4& shape, u32 flag, bool plan_only, isize n_threads) {
        ...
        check(strides.physical_shape()[2] >= shape[3] + 1 + static_cast<isize>(is_even(shape[3])));

        const auto complex_strides = Strides4{strides[0] / 2, strides[1] / 2, strides[2] / 2, strides[3]};
    ...
    template<typename T>
    void c2r(Complex<T>* data, const Strides4& strides, const Shape4& shape, u32 flag, bool plan_only, isize n_threads) {
        const auto real_strides = Strides4{strides[0] * 2, strides[1] * 2, strides[2] * 2, strides[3]};
    ...
    void c2c(
        Complex<T>* input, const Strides4& input_strides,
        Complex<T>* output, const Strides4& output_strides,
        const Shape4& shape, nf::Sign sign, u32 flag, bool plan_only, isize n_threads
    ) {
    ...
    void c2c(
        ...
        nf::Sign sign, u32 flag, bool plan_only, isize n_threads
    ) {
