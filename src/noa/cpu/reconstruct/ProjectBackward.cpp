    ...
    void fourierInsert(const Complex<T>* proj, const T* proj_weights, int proj_dim,
        ...
        for (int y = 0; y < proj_dim; ++y) {
            ...
            for (u = 0; u < proj_dim_half + 1; ++u) { // x == u
                ...
                if (idx0.x < 0 || idx1.x >= volume_dim_half ||
                ...
                Complex<T> proj_value = proj[y * proj_dim_half + u]; // x == u
                proj_value.imag *= conj;
                T proj_weight = proj_weights[y * proj_dim_half + u];
                ...
                volume[(idx0.z * volume_dim + idx0.y) * volume_dim_half + idx0.x] += proj_value * weights[0];
                volume[(idx0.z * volume_dim + idx0.y) * volume_dim_half + idx1.x] += proj_value * weights[1];
                volume[(idx0.z * volume_dim + idx1.y) * volume_dim_half + idx0.x] += proj_value * weights[2];
                volume[(idx0.z * volume_dim + idx1.y) * volume_dim_half + idx1.x] += proj_value * weights[3];
                volume[(idx1.z * volume_dim + idx0.y) * volume_dim_half + idx0.x] += proj_value * weights[4];
                volume[(idx1.z * volume_dim + idx0.y) * volume_dim_half + idx1.x] += proj_value * weights[5];
                volume[(idx1.z * volume_dim + idx1.y) * volume_dim_half + idx0.x] += proj_value * weights[6];
                volume[(idx1.z * volume_dim + idx1.y) * volume_dim_half + idx1.x] += proj_value * weights[7];

                volume_weights[(idx0.z * volume_dim + idx0.y) * volume_dim_half + idx0.x] += proj_weight * weights[0];
                volume_weights[(idx0.z * volume_dim + idx0.y) * volume_dim_half + idx1.x] += proj_weight * weights[1];
                volume_weights[(idx0.z * volume_dim + idx1.y) * volume_dim_half + idx0.x] += proj_weight * weights[2];
                volume_weights[(idx0.z * volume_dim + idx1.y) * volume_dim_half + idx1.x] += proj_weight * weights[3];
                volume_weights[(idx1.z * volume_dim + idx0.y) * volume_dim_half + idx0.x] += proj_weight * weights[4];
                volume_weights[(idx1.z * volume_dim + idx0.y) * volume_dim_half + idx1.x] += proj_weight * weights[5];
                volume_weights[(idx1.z * volume_dim + idx1.y) * volume_dim_half + idx0.x] += proj_weight * weights[6];
                volume_weights[(idx1.z * volume_dim + idx1.y) * volume_dim_half + idx1.x] += proj_weight * weights[7];
            }
        }
    }
