...
namespace noa::cpu::math {
    ...
    /// \note The divide*, add* and subtract* functions operate similarly, but uses the operators, /, + and -, respectively.
    template<typename T, typename U>
    NOA_IH void multiplyByValue(const T* inputs, const U* values, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
    ...
    /// \note The divide*, add* and subtract* functions operate similarly, but uses the operators, /, + and -, respectively.
    template<typename T, typename U>
    NOA_IH void multiplyByArray(const T* inputs, const U* array, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
...
namespace noa::cpu::math {
    ...
    /// \see This function has the same features and restrictions than noa::cpu::math::multiplyByValue().
    template<typename T, typename U>
    NOA_IH void divideByValue(const T* inputs, U* values, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
    ...
    template<typename T, typename U>
    NOA_IH void divideByArray(const T* inputs, U* array, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
    ...
    NOA_IH void divideSafeByArray(const T* inputs, U* array, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
...
namespace noa::cpu::math {
    ...
    /// \see This function has the same features and restrictions than noa::cpu::math::multiplyByValue().
    template<typename T, typename U>
    NOA_IH void addValue(const T* inputs, U* values, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
    ...
    /// \see This function has the same features and restrictions than noa::cpu::math::multiplyByArray().
    template<typename T, typename U>
    NOA_IH void addArray(const T* inputs, U* array, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
...
namespace noa::cpu::math {
    ...
    /// \see This function has the same features and restrictions than noa::cpu::math::multiplyByValue().
    template<typename T, typename U>
    NOA_IH void subtractValue(const T* inputs, U* values, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
    ...
    /// \see This function has the same features and restrictions than noa::cpu::math::multiplyByArray().
    template<typename T, typename U>
    NOA_IH void subtractArray(const T* inputs, U* array, T* outputs, size_t elements, size_t batches) {
        NOA_PROFILE_FUNCTION();
