...
namespace noa::cpu::math {
    ...
    template<typename T, typename = std::enable_if_t<guts::is_valid_dot_t<T>>>
    ...
    template<typename T, typename = std::enable_if_t<guts::is_valid_matmul_t<T>>>
