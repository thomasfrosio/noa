...
#define NOA_INSTANTIATE_EWISE_TRINARY_ARITHMETIC(T, U, V, W)                \
    NOA_CUDA_EWISE_TRINARY_INSTANTIATE_API(T,U,V,W,::noa::minus_t)          \
    NOA_CUDA_EWISE_TRINARY_INSTANTIATE_API(T,U,V,W,::noa::minus_plus_t)     \
    NOA_CUDA_EWISE_TRINARY_INSTANTIATE_API(T,U,V,W,::noa::minus_multiply_t) \
    NOA_CUDA_EWISE_TRINARY_INSTANTIATE_API(T,U,V,W,::noa::minus_divide_t)
