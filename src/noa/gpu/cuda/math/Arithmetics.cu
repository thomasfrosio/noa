...
namespace Noa::CUDA::Math::Details {
    ...
    void arithByValue(T* input, U value, T* output, size_t elements, Stream& stream) {
        ...
        NOA_CUDA_LAUNCH(blocks, Details::Contiguous::BLOCK_SIZE, 0, stream.get(),
                        Details::Contiguous::computeSingleValue<ARITH>,
    ...
    void arithByArray(T* inputs, U* array, T* outputs, size_t elements, uint batches, Stream& stream) {
        uint blocks = Details::Contiguous::getBlocks(elements);
        NOA_CUDA_LAUNCH(dim3(blocks, batches), Details::Contiguous::BLOCK_SIZE, 0, stream.get(),
                        Details::Contiguous::computeElementWise<ARITH>,
    ...
    void arithByValue(T* input, size_t pitch_input, U value,
        ...
        NOA_CUDA_LAUNCH(blocks, Details::Padded::BLOCK_SIZE, 0, stream.get(),
                        Details::Padded::computeSingleValue<ARITH>,
    ...
    void arithByArray(T* inputs, size_t pitch_inputs,
        ...
        uint blocks = Details::Padded::getBlocks(shape2d);
        NOA_CUDA_LAUNCH(dim3(blocks, batches), Details::Padded::BLOCK_SIZE, 0, stream.get(),
                        Details::Padded::computeElementWise<ARITH>,
...
namespace Noa::CUDA::Math {
    ...
    INSTANTIATE_ARITH(int32_t, int32_t);
    INSTANTIATE_ARITH(uint32_t, uint32_t);
