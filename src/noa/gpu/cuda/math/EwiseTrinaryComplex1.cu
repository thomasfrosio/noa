...
namespace noa::cuda::math {
    ...
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::multiply_t);         \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::multiply_plus_t);    \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::multiply_minus_t);   \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::multiply_divide_t);  \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::divide_t);           \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::divide_plus_t);      \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::divide_minus_t);     \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::divide_multiply_t);  \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::math::divide_epsilon_t)
