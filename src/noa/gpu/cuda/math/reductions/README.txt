...
These reduction kernels are adapted from different sources, but they mostly come from:
...
TODO The reductions often use a second kernel launch as synchronization barrier.
     1) With cooperative groups, grid synchronization is possible but forces CUDA 9.0 minimum, which is fine.
     ...
     4) The best option is likely to rely on CUB for this...
