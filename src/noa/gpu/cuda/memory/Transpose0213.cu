...
template void noa::cuda::memory::details::transpose0213<T>(const T*, size4_t, T*, size4_t, size4_t, Stream&);   \
template void noa::cuda::memory::details::inplace::transpose0213<T>(T*, size4_t, size4_t, Stream&)
