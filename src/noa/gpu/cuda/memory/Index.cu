...
namespace {
    ...
    noa::cuda::memory::Extracted<T, I> extract_elements_(
        ...
        const auto inclusive_sum = noa::cuda::memory::AllocatorDevice<i32>::allocate_async(elements, stream);
        {
            ...
            const auto cub_buffer = noa::cuda::memory::AllocatorDevice<Byte>::allocate_async(
        ...
        output_t extracted{
            extract_values ? noa::cuda::memory::AllocatorDevice<T>::allocate_async(elements_to_extract, stream) : nullptr,
            extract_offsets ? noa::cuda::memory::AllocatorDevice<I>::allocate_async(elements_to_extract, stream) : nullptr,
            elements_to_extract
        };
    ...
    auto extract_unary_wrapper(
            ...
            UnaryOp unary_op, bool extract_values, bool extract_offsets, noa::cuda::Stream& stream
    ) -> noa::cuda::memory::Extracted<ExtractedValue, ExtractedOffset> {
        ...
        const auto binary_map = noa::cuda::memory::AllocatorDevice<i32>::allocate_async(elements, stream);
