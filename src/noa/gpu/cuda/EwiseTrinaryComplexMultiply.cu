...
namespace noa::cuda {
    ...
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::multiply_t);         \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::multiply_plus_t);    \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::multiply_minus_t);   \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::multiply_divide_t)
