...
namespace noa::cuda::fft {
    ...
    void r2c(
        ...
        Complex<T>* output, const Strides4& output_strides, const Shape4& shape,
    ...
    template<typename T>
    void r2c(
        T* data, const Strides4& strides, const Shape4& shape,
        bool cache_plan, bool plan_only, bool record_workspace, Stream& stream
    ) {
    ...
    void c2r(
        ...
        T* output, const Strides4& output_strides, const Shape4& shape,
        bool cache_plan, bool plan_only, bool record_workspace, Stream& stream
    ) {
        Plan<T>(
