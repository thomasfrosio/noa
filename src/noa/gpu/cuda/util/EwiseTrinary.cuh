...
namespace noa::cuda::util::ewise::details {
    ...
    template<typename lhs_val_t, typename mhs_val_t, typename rhs_val_t,
            ...
            int VEC_SIZE, bool RESTRICT>
    __global__ __launch_bounds__(TrinaryConfig::BLOCK_SIZE)
    void trinaryArrayValue1D_(accessor_t<RESTRICT, const lhs_val_t*> lhs, uint2_t lhs_stride,
    ...
    template<typename lhs_val_t, typename mhs_val_t, typename rhs_val_t,
             typename out_val_t, typename trinary_t, bool RESTRICT>
    __global__ __launch_bounds__(TrinaryConfig::BLOCK_SIZE)
    void trinaryArrayValue4D_(accessor_t<RESTRICT, const lhs_val_t*> lhs, uint4_t lhs_stride,
    ...
    template<typename lhs_val_t, typename mhs_val_t, typename rhs_val_t,
            ...
            int VEC_SIZE, bool RESTRICT>
    __global__ __launch_bounds__(TrinaryConfig::BLOCK_SIZE)
    void trinaryValueArray1D_(accessor_t<RESTRICT, const lhs_val_t*> lhs, uint2_t lhs_stride,
                              rhs_val_t mhs,
                              accessor_t<RESTRICT, const mhs_val_t*> rhs, uint2_t rhs_stride,
                              accessor_t<RESTRICT, out_val_t*> output, uint2_t output_stride,
                              uint elements, trinary_t trinary_op) {
        constexpr uint BLOCK_SIZE = TrinaryConfig::BLOCK_SIZE;
        constexpr uint BLOCK_WORK_SIZE = TrinaryConfig::BLOCK_WORK_SIZE;
    ...
    template<typename lhs_val_t, typename mhs_val_t, typename rhs_val_t,
             typename out_val_t, typename trinary_t, bool RESTRICT>
    __global__ __launch_bounds__(TrinaryConfig::BLOCK_SIZE)
    void trinaryValueArray4D_(accessor_t<RESTRICT, const lhs_val_t*> lhs, uint4_t lhs_stride,
                              mhs_val_t mhs,
...
namespace noa::cuda::util::ewise {
    ...
    void trinary(const char* name,
                 const lhs_val_t* lhs, size4_t lhs_stride,
                 const mhs_val_t* mhs, size4_t mhs_stride, rhs_t rhs,
                 out_val_t* output, size4_t output_stride,
                 size4_t shape, Stream& stream, trinary_t trinary_op) {
        using namespace details;
        using rhs_val_t = std::remove_const_t<rhs_t>;
        ...
        if (is_contiguous[1] && is_contiguous[2]) {
            ...
            if (blocks.y > 1)
                vec_size = lhs_stride[0] % vec_size ||
                           mhs_stride[0] % vec_size ||
                           output_stride[0] % vec_size ? 1 : vec_size;
            ...
            if (vec_size == 4) {
                return stream.enqueue(
                        ...
                        config, lhs_accessor, uint_lhs_stride, mhs_accessor, uint_mhs_stride, rhs,
                        output_accessor, uint_output_stride, elements, trinary_op);
            } else if (vec_size == 2) {
                return stream.enqueue(
            ...
            stream.enqueue(name, trinaryArrayValue4D_<lhs_val_t, mhs_val_t, rhs_val_t, out_val_t, trinary_t, RESTRICT>,
                           config, lhs_accessor, uint4_t{lhs_stride}, mhs_accessor, uint4_t{mhs_stride}, rhs,
                           output_accessor, uint4_t{output_stride}, i_shape, trinary_op, blocks_x);
        }
    }
    ...
    void trinary(const char* name,
                 const lhs_val_t* lhs, size4_t lhs_stride, mhs_t mhs,
        ...
        if (is_contiguous[1] && is_contiguous[2]) {
            ...
            if (vec_size == 4) {
                return stream.enqueue(
                        ...
                        config, lhs_accessor, uint_lhs_stride, mhs, rhs_accessor, uint_rhs_stride,
                        output_accessor, uint_output_stride, elements, trinary_op);
            } else if (vec_size == 2) {
                return stream.enqueue(
            ...
            stream.enqueue(name, trinaryValueArray4D_<lhs_val_t, mhs_val_t, rhs_val_t, out_val_t, trinary_t, RESTRICT>,
                           config, lhs_accessor, uint4_t{lhs_stride}, mhs, rhs_accessor, uint4_t{rhs_stride},
                           output_accessor, uint4_t{output_stride}, i_shape, trinary_op, blocks_x);
        }
    }
