...
namespace noa::cuda {
    ...
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::divide_t);           \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::divide_plus_t);      \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::divide_minus_t);     \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::divide_multiply_t);  \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::divide_epsilon_t)
