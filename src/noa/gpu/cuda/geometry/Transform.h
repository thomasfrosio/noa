...
namespace noa::cuda::geometry {
    ...
    /// \param input_shape      BDHW, in elements, shape of \p input.
    ...
    /// \param[in] matrices     One the \b host or \b device. 2x3 or 3x3 inverse HW affine matrices. One per batch.
    ...
    /// \param[in] matrices     One the \b host or \b device. 3x4 or 4x4 inverse DHW affine matrices. One per batch.
...
namespace noa::cuda::geometry {
    ...
    /// \param texture_shape        HW shape of \p texture.
    ...
    /// \param texture              Input texture bound to a CUDA array.
    /// \param texture_shape        DHW shape of \p texture.
    ...
    /// \param output_strides       BDHW strides, in elements, of \p output.
    /// \param output_shape         BDHW shape, in elements, of \p output.
    /// \param[in] matrix           One the \b host or \b device. 3x4 or 4x4 inverse DHW affine matrices. One per batch.
    /// \param[in,out] stream       Stream on which to enqueue this function.
    ///
    /// \note This function is asynchronous relative to the host and may return before completion.
    ///       As such, one must make sure the texture and the CUDA array it is bound to stays valid until completion.
...
namespace noa::cuda::geometry {
    ...
    /// \param output_strides       BDHW strides, in elements, of \p output.
    /// \param output_shape         BDHW shape, in elements, of \p output.
    /// \param shift                HW shifts to apply before the other transformations.
    /// \param matrix               HW inverse rotation/scaling to apply after the shift.
    /// \param[in] symmetry         Symmetry operator to apply after the rotation/scaling.
    /// \param center               HW index of the transformation center.
    /// \param[in,out] stream       Stream on which to enqueue this function.
    ...
    /// \param output_strides       BDHW strides, in elements, of \p output.
    /// \param output_shape         BDHW shape, in elements, of \p output.
    /// \param shift                DHW shifts to apply before the other transformations.
    /// \param matrix               DHW inverse rotation/scaling to apply after the shift.
    /// \param[in] symmetry         Symmetry operator to apply after the rotation/scaling.
    /// \param center               DHW index of the transformation center.
    /// \param[in,out] stream       Stream on which to enqueue this function.
