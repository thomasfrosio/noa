...
namespace {
    ...
    shift3D_(cudaTextureObject_t texture, float3_t texture_shape,
        ...
        output[at(gid, output_stride)] = cuda::geometry::tex3D<T, MODE>(texture, pos);
    }
    ...
    void launchShift3D_(const T* input, size4_t input_stride, size4_t input_shape,
...
namespace noa::cuda::geometry {
    ...
    template void shift3D<false, T>(const T*, size4_t, size4_t, T*, size4_t, size4_t, const float3_t*, InterpMode, BorderMode, Stream&); \
    template void shift3D<true, T>(const T*, size4_t, size4_t, T*, size4_t, size4_t, const float3_t*, InterpMode, BorderMode, Stream&);  \
    template void shift3D<false, T>(const T*, size4_t, size4_t, T*, size4_t, size4_t, float3_t, InterpMode, BorderMode, Stream&);        \
    template void shift3D<true, T>(const T*, size4_t, size4_t, T*, size4_t, size4_t, float3_t, InterpMode, BorderMode, Stream&)
