...
namespace noa::cuda {
    ...
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::plus_t);           \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::plus_multiply_t);  \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::plus_minus_t);     \
    NOA_INSTANTIATE_EWISE_TRINARY(T,U,V,W,::noa::plus_divide_t)
