...
namespace noa::traits {
    ...
    template<usize N, typename... T>
    concept subregion_access_sequence = details::SubregionParser<N, T...>::value;
}
...
namespace noa {
    ...
    template<usize N, typename... T>
        requires nt::subregion_access_sequence<N, T...>
    struct Subregion {
    ...
    template<usize N, typename... T> requires nt::subregion_access_sequence<N, T...>
    constexpr auto make_subregion(const T&... access_sequence) noexcept {
        return Subregion<N, T...>(access_sequence...);
    }
}
