...
namespace noa::signal::details {
    ...
    template<int32_t NDIM, typename Value, typename Matrix, typename Functor, typename CValue>
...
namespace noa::signal {
    ...
    template<typename Value, typename Matrix = float33_t,
             typename Functor = noa::math::multiply_t,
    ...
    /// \param invert       Whether the mask should be inverted, i.e. elements inside the mask are set to 0,
    ///                     and elements outside the mask are set to \p cvalue.
    template<typename Value, typename Matrix = float22_t,
             typename Functor = noa::math::multiply_t,
             typename CValue = traits::value_type_t<Value>,
