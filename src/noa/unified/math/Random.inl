...
namespace noa::math {
    ...
    template<typename T, typename U, typename>
    [[nodiscard]] Array<T> random(noa::math::normal_t, dim4_t shape, U mean, U stddev, ArrayOption option) {
        Array<T> out(shape, option);
    ...
    template<typename T, typename U, typename>
    [[nodiscard]] Array<T> random(noa::math::log_normal_t, dim4_t shape, U mean, U stddev, ArrayOption option) {
        Array<T> out(shape, option);
    ...
    template<typename T, typename U, typename>
    [[nodiscard]] Array<T> random(noa::math::normal_t, dim_t elements, U mean, U stddev, ArrayOption option) {
        Array<T> out(elements, option);
        randomize(noa::math::normal_t{}, out, mean, stddev);
        return out;
    }
    ...
    template<typename T, typename U, typename>
    [[nodiscard]] Array<T> random(noa::math::log_normal_t, dim_t elements, U mean, U stddev, ArrayOption option) {
        Array<T> out(elements, option);
        randomize(noa::math::log_normal_t{}, out, mean, stddev);
        return out;
    }
