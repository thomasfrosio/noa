...
namespace noa {
    ...
    NOA_UNARY_OP_(Log10, return log10(src));
    NOA_UNARY_OP_(Log1p, return log1p(src));
    NOA_UNARY_OP_(Abs, return abs(src));
    NOA_UNARY_OP_(Cos, return cos(src));
    NOA_UNARY_OP_(Sin, return sin(src));
    NOA_UNARY_OP_(Tan, return tan(src));
    NOA_UNARY_OP_(Acos, return acos(src));
    NOA_UNARY_OP_(Asin, return asin(src));
    NOA_UNARY_OP_(Atan, return atan(src));
    NOA_UNARY_OP_(Cosh, return cosh(src));
    NOA_UNARY_OP_(Sinh, return sinh(src));
    NOA_UNARY_OP_(Tanh, return tanh(src));
    NOA_UNARY_OP_(Acosh, return acosh(src));
    NOA_UNARY_OP_(Asinh, return asinh(src));
    NOA_UNARY_OP_(Atanh, return atanh(src));
    NOA_UNARY_OP_(Atan2, return atan2(src));
    NOA_UNARY_OP_(Sinc, return sinc(src));
    NOA_UNARY_OP_(Real, return real(src));
    NOA_UNARY_OP_(Imag, return imag(src));
    NOA_UNARY_OP_(Conj, return conj(src));
    NOA_UNARY_OP_(Signbit, return signbit(src));
    NOA_UNARY_OP_(Rad2Deg, return rad2deg(src));
    NOA_UNARY_OP_(Deg2Rad, return deg2rad(src));
    ...
    NOA_UNARY_OP_(IsNaN, return is_nan(src));
    NOA_UNARY_OP_(IsInf, return is_inf(src));
    NOA_UNARY_OP_(IsFinite, return is_finite(src));
    NOA_UNARY_OP_(IsNormal, return is_normal(src));
    ...
    NOA_BINARY_OP_(Pow, return pow(lhs, rhs));
    NOA_BINARY_OP_(Hypot, return hypot(lhs, rhs));
    NOA_BINARY_OP_(Copysign, return copysign(lhs, rhs));
    ...
    NOA_TRINARY_OP_(Fma, return fma(lhs, mhs, rhs));
    ...
    struct Cast {
        ...
        template<typename T, typename U>
            requires ((nt::complex<T> and nt::real<U>) or nt::static_castable_to<T, U>)
        NOA_HD constexpr void operator()(const T& src, U& dst) const {
