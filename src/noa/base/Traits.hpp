...
namespace noa::traits {
    ...
    template<typename, size_t> struct proclaim_is_mat_of_row : std::false_type {};
    template<typename T, size_t R> using is_mat_of_row = proclaim_is_mat_of_row<std::remove_cv_t<T>, R>;
    template<typename T, size_t R> constexpr bool is_mat_of_row_v = is_mat_of_row<T, R>::value;
    template<typename T, size_t R> concept mat_of_row = mat<T> and is_mat_of_row_v<T, R>;
    template<size_t R, typename... T> using are_mat_of_row = conjunction_or_false<is_mat_of_row<T, R>...>;
    template<size_t R, typename... T> constexpr bool are_mat_of_row_v = are_mat_of_row<R, std::decay_t<T>...>::value;

    template<typename, size_t> struct proclaim_is_mat_of_col : std::false_type {};
    template<typename T, size_t R> using is_mat_of_col = proclaim_is_mat_of_col<std::remove_cv_t<T>, R>;
    template<typename T, size_t R> constexpr bool is_mat_of_col_v = is_mat_of_col<T, R>::value;
    template<typename T, size_t R> concept mat_of_col = mat<T> and is_mat_of_col_v<T, R>;
    template<size_t R, typename... T> using are_mat_of_col = conjunction_or_false<is_mat_of_col<T, R>...>;
    template<size_t R, typename... T> constexpr bool are_mat_of_col_v = are_mat_of_col<R, std::decay_t<T>...>::value;
