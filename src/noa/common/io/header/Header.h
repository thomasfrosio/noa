...
namespace noa::io::details {
    ...
    public:
        ...
        [[nodiscard]]  virtual size3_t getShape() const noexcept = 0;
        ...
        virtual void readShape(void* output, DataType data_type, size3_t offset, size3_t shape, bool clamp) = 0;
        ...
        virtual void writeShape(const void* input, DataType data_type, size3_t offset, size3_t shape, bool clamp) = 0;
