...
namespace noa {
    ...
    template<typename T> struct traits::proclaim_is_int4<Int4<T>> : std::true_type {};
    template<typename T> struct traits::proclaim_is_uint4<Int4<T>> : std::bool_constant<is_uint_v<T>> {};
