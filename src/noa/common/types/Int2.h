...
namespace noa {
    ...
    public: // Component accesses
        ...
        NOA_HD [[nodiscard]] constexpr Int2 flip() const noexcept { return {m_data[1], m_data[0]}; }
        ...
        NOA_HD [[nodiscard]] constexpr Int2 strides() const noexcept {
            return {m_data[1], 1};
        }

        NOA_HD [[nodiscard]] constexpr T pitches() const noexcept {
            return m_data[0];
        }
        ...
        NOA_HD [[nodiscard]] constexpr Int2 fft() const noexcept {
