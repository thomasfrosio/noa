...
namespace noa {
    ...
    namespace math {
        ...
        template<typename T>
        [[nodiscard]] NOA_FHD constexpr T innerProduct(Float4<T> a, Float4<T> b) noexcept {
            return dot(a, b);
        }
    ...
    namespace traits {
        ...
        template<typename T>
        struct p_is_float4<Float4<T>> : std::true_type {};
        ...
        template<typename T>
        struct proclaim_is_floatX<Float4<T>> : std::true_type {};
    }
