...
namespace noa {
    ...
    public: // Conversion constructors
        ...
        NOA_HD constexpr Bool3(X a0, Y a1, Z a2) noexcept
                : m_data{static_cast<bool>(a0), static_cast<bool>(a1), static_cast<bool>(a2)} {}
        ...
        template<typename U, typename = std::enable_if_t<traits::is_scalar_v<U>>>
        NOA_HD constexpr explicit Bool3(const U* ptr) noexcept {
    ...
    // -- Boolean operators --
    [[nodiscard]] NOA_FHD constexpr Bool3 operator!(Bool3 rhs) noexcept {
        return {!rhs[0], !rhs[1], !rhs[2]};
    }

    [[nodiscard]] NOA_FHD constexpr Bool3 operator==(Bool3 lhs, Bool3 rhs) noexcept {
        return {lhs[0] == rhs[0], lhs[1] == rhs[1], lhs[2] == rhs[2]};
    }

    [[nodiscard]] NOA_FHD constexpr Bool3 operator==(Bool3 lhs, bool rhs) noexcept {
        return {lhs[0] == rhs, lhs[1] == rhs, lhs[2] == rhs};
    }

    [[nodiscard]] NOA_FHD constexpr Bool3 operator==(bool lhs, Bool3 rhs) noexcept {
    ...
    [[nodiscard]] NOA_FHD constexpr bool any(Bool3 v) noexcept {
        return v[0] || v[1] || v[2];
    }

    [[nodiscard]] NOA_FHD constexpr bool all(Bool3 v) noexcept {
        return v[0] && v[1] && v[2];
    }

    using bool3_t = Bool3;

    [[nodiscard]] NOA_IH constexpr std::array<bool, 3> toArray(Bool3 v) noexcept {
        return {v[0], v[1], v[2]};
    }

    template<>
    [[nodiscard]] NOA_IH std::string string::human<Bool3>() {
        return "bool3";
    }
    ...
    template<>
    struct traits::proclaim_is_bool3<Bool3> : std::true_type {};
}
