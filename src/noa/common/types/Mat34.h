...
namespace noa {
    ...
    template<>
    NOA_IH std::string string::typeName<float34_t>() { return "float34"; }
    template<>
    NOA_IH std::string string::typeName<double34_t>() { return "double34"; }

    template<typename T>
    NOA_IH std::ostream& operator<<(std::ostream& os, Mat34<T> m) {
