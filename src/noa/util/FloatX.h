/**
 * @file FloatX.h
 * @brief Float2, Float3 and Float4 templated structs.
...
namespace Noa {
    ...
    struct NOA_API Float3 {
        ...
        [[nodiscard]] inline constexpr std::array<Float, 3U> toArray() const noexcept { return {x, y, z}; }
...
namespace Noa {
    ...
    struct NOA_API Float4 {
        ...
        [[nodiscard]] inline constexpr std::array<Float, 4U> toArray() const noexcept { return {x, y, z, w}; }
...
struct fmt::formatter<FloatX, std::enable_if_t<Noa::Traits::is_floatX_v<FloatX>, char>> : fmt::formatter<std::string> {
