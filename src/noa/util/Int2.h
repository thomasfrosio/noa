...
namespace Noa {
    ...
    struct Int2 {
        ...
        NOA_IHD constexpr Int2<T>& operator=(T v) noexcept {
            x = v;
            y = v;
            return *this;
        }

        NOA_IHD constexpr Int2<T>& operator=(T* ptr) noexcept {
            x = ptr[0];
            y = ptr[1];
            return *this;
        }
        ...
        template<typename U>
        NOA_IHD constexpr auto& operator=(Int2<U> vec) noexcept {
            x = T(vec.x);
            y = T(vec.y);
            return *this;
        }
        ...
        template<typename U>
        NOA_IHD constexpr auto& operator=(Float2<U> vec) noexcept {
            x = T(vec.x);
            y = T(vec.y);
            return *this;
        }

        NOA_IHD constexpr Int2<T>& operator+=(const Int2<T>& rhs) noexcept;
        NOA_IHD constexpr Int2<T>& operator-=(const Int2<T>& rhs) noexcept;
        NOA_IHD constexpr Int2<T>& operator*=(const Int2<T>& rhs) noexcept;
        NOA_IHD constexpr Int2<T>& operator/=(const Int2<T>& rhs) noexcept;

        NOA_IHD constexpr Int2<T>& operator+=(T rhs) noexcept;
        NOA_IHD constexpr Int2<T>& operator-=(T rhs) noexcept;
        NOA_IHD constexpr Int2<T>& operator*=(T rhs) noexcept;
        NOA_IHD constexpr Int2<T>& operator/=(T rhs) noexcept;
    ...
    template<typename I>
    NOA_IHD constexpr Int2<I> operator+(Int2<I> lhs, Int2<I> rhs) noexcept {
        return {lhs.x + rhs.x, lhs.y + rhs.y};
    }
    template<typename I>
    NOA_IHD constexpr Int2<I> operator+(I lhs, Int2<I> rhs) noexcept {
        return {lhs + rhs.x, lhs + rhs.y};
    }
    template<typename I>
    NOA_IHD constexpr Int2<I> operator+(Int2<I> lhs, I rhs) noexcept {
    ...
    template<typename I>
    NOA_IHD constexpr Int2<I>& Int2<I>::operator+=(const Int2<I>& rhs) noexcept {
        *this = *this + rhs;
        return *this;
    }
    template<typename I>
    NOA_IHD constexpr Int2<I>& Int2<I>::operator+=(I rhs) noexcept {
        *this = *this + rhs;
        return *this;
    }
    ...
    template<typename I>
    NOA_IHD constexpr bool operator>(const Int2<I>& lhs, const Int2<I>& rhs) noexcept {
        return lhs.x > rhs.x && lhs.y > rhs.y;
    }
    template<typename I>
    NOA_IHD constexpr bool operator>(const Int2<I>& lhs, I rhs) noexcept {
        return lhs.x > rhs && lhs.y > rhs;
    }
    template<typename I>
    NOA_IHD constexpr bool operator>(I lhs, const Int2<I>& rhs) noexcept {
        return lhs > rhs.x && lhs > rhs.y;
    }
...
namespace Noa::Math {
    template<class T>
    [[nodiscard]] NOA_IHD constexpr T sum(const Int2<T>& v) noexcept {
        return v.x + v.y;
    }

    template<class T>
    [[nodiscard]] NOA_IHD constexpr T prod(const Int2<T>& v) noexcept {
        return v.x * v.y;
    }
    ...
    template<class T>
    [[nodiscard]] NOA_IHD constexpr Int2<T> min(Int2<T> lhs, T rhs) {
        return {min(lhs.x, rhs), min(lhs.y, rhs)};
    }

    template<class T>
    [[nodiscard]] NOA_IHD constexpr Int2<T> min(T lhs, Int2<T> rhs) {
        return {min(lhs, rhs.x), min(lhs, rhs.y)};
    }

    template<class T>
    [[nodiscard]] NOA_IHD constexpr Int2<T> max(Int2<T> lhs, Int2<T> rhs) {
        return {max(lhs.x, rhs.x), max(lhs.y, rhs.y)};
    }

    template<class T>
    [[nodiscard]] NOA_IHD constexpr Int2<T> max(Int2<T> lhs, T rhs) {
