...
#include "noa/io/IO.h" // IO::OpenMode, IO::DataType
...
namespace Noa {
    ...
    public:
        ...
        /// @warning the fields @a sum and @a variance are not computed and set to 0.
        ...
        /// @note the fields @a min, @a max, @a mean and @a stdev are used, the rest is ignored.
