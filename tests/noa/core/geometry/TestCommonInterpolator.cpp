...
TEST_CASE("common::geometry, Interpolator", "[noa][core]") {
    ...
    noa::geometry::interpolator_3d<BorderMode::MIRROR, InterpMode::CUBIC_BSPLINE>(accessor0, shape0, 0.f)({}, 0);
    noa::geometry::interpolator_3d<BorderMode::MIRROR, InterpMode::CUBIC>(accessor0, shape0, 0.f)({}, 0);
    noa::geometry::interpolator_3d<BorderMode::MIRROR, InterpMode::NEAREST>(accessor0, shape0, 0.f)({}, 0);
    ...
    noa::geometry::interpolator_2d<BorderMode::MIRROR, InterpMode::CUBIC>(accessor2, shape1, 0.f)({}, 0);
    noa::geometry::interpolator_2d<BorderMode::MIRROR, InterpMode::NEAREST>(accessor2, shape1, 0.f)({}, 0);
