...
TEMPLATE_TEST_CASE("base::clamp_cast, floating-point to signed integer", "", i8, i16, i32, i64) {
...
TEMPLATE_TEST_CASE("base::clamp_cast, floating-point to unsigned integer", "", u8, u16, u32, u64) {
    using int_limit = std::numeric_limits<TestType>;
    REQUIRE(123 == noa::clamp_cast<TestType>(123.f));
...
TEMPLATE_TEST_CASE("base::clamp_cast, integer to floating-point", "", i8, i16, i32, i64, u8, u16, u32, u64) {
    using int_limit = std::numeric_limits<TestType>;
...
TEMPLATE_TEST_CASE("base::clamp_cast, f16 to f32/f64", "", f32, double) {
...
TEMPLATE_TEST_CASE("base::clamp_cast, small integer to f16", "", i8, i16, u8) {
    using int_limit = std::numeric_limits<TestType>;
...
TEMPLATE_TEST_CASE("base::clamp_cast, large integer to f16", "", i32, i64, u16, u32, u64) {
    using int_limit = std::numeric_limits<TestType>;
...
TEST_CASE("base::clamp_cast, f64 to f32/f16") {
...
TEMPLATE_TEST_CASE("base::clamp_cast, scalar to complex", "", i8, i16, i32, i64, u8, u16, u32, u64, f16, f32, f64) {
...
TEST_CASE("base::clamp_cast, integer to integer") {
    // Unsigned to sign:
