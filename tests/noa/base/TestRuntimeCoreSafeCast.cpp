...
TEMPLATE_TEST_CASE("base::safe_cast, floating-point to signed integer", "", i8, i16, i32, i64) {
...
TEMPLATE_TEST_CASE("base::safe_cast, floating-point to unsigned integer", "", u8, u16, u32, u64) {
    REQUIRE(123 == noa::safe_cast<TestType>(123.f));
...
TEMPLATE_TEST_CASE("base::safe_cast, integer to floating-point", "", i8, i16, i32, i64, u8, u16, u32, u64) {
    using int_limit = std::numeric_limits<TestType>;
...
TEMPLATE_TEST_CASE("base::safe_cast, f16 to float/double", "", f32, f64) {
...
TEMPLATE_TEST_CASE("base::safe_cast, small integer to f16", "", i8, i16, u8) {
    using int_limit = std::numeric_limits<TestType>;
...
TEMPLATE_TEST_CASE("base::safe_cast, large integer to half_t", "", i32, i64, u16, u32, u64) {
    using int_limit = std::numeric_limits<TestType>;
...
TEST_CASE("base::safe_cast, double to float/f16") {
...
TEST_CASE("base::safe_cast, integer to integer") {
    // Unsigned to sign:
