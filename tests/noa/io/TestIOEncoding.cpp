...
TEMPLATE_TEST_CASE("io::encoding and decoding - real types", "", u8, i16, i32, u32, f16, f32, f64) {
...
TEMPLATE_TEST_CASE("io::encoding and decoding - complex", "", c16, c32, c64) {
    const fs::path directory = "test_encoding";
    const fs::path filename = directory / "data";
    nio::mkdir(directory);
...
TEST_CASE("io::encoding and decoding - many elements") {
    const fs::path directory = "test_encoding";
    const fs::path filename = directory / "data";
    nio::mkdir(directory);
