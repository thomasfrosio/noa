...
TEST_CASE("xform::sphere(), 2d", "[asset]") {
    ...
    for (size_t nb = 0; nb < tests.size(); ++nb) {
        ...
        if constexpr (COMPUTE_ASSETS) {
            ...
            noa::xform::draw_2d({}, asset, sphere.get());
        ...
        for (const auto& device: devices) {
            ...
            noa::xform::draw_2d({}, result, sphere.get<f32>());
            ...
            noa::xform::draw_2d(data, data, sphere.get<f32>());
            ...
            noa::xform::draw_2d(data, data, inverted_sphere.get<f32>());
...
//         if constexpr (COMPUTE_ASSETS) {
//             const auto asset = noa::empty<f32>(shape);
//             noa::xform::draw({}, asset, rectangle.get(), inv_matrix);
//             noa::write_image(asset, filename_expected);
//             continue;
//         }
//
...
//             // Save shape into the output.
//             const auto result = noa::empty<f32>(shape, option);
//             noa::xform::draw({}, result, rectangle.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(result, asset, 5e-5));
//
//             // Apply the shape onto the input, in-place.
//             const auto data = noa::random(noa::Uniform{-10.f, 10.f}, shape, option);
//             noa::ewise(noa::wrap(result, data), result, noa::Multiply{});
//             noa::xform::draw(data, data, rectangle.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(result, data, 5e-5));
//
//             // Apply the shape onto the input, in-place, invert.
//             noa::randomize(noa::Uniform{-10.f, 10.f}, data);
//             noa::ewise(noa::wrap(data, asset), asset, ApplyInvertedMask{static_cast<f32>(cvalue)});
//             noa::xform::draw(data, data, inverted_rectangle.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(asset, data, 5e-5));
//         }
//     }
// }
...
//         if constexpr (COMPUTE_ASSETS) {
//             const auto asset = noa::empty<f32>(shape);
//             noa::xform::draw({}, asset, ellipse.get(), inv_matrix);
//             noa::write_image(asset, filename_expected);
//             continue;
//         }
//
...
//             // Save shape into the output.
//             const auto result = noa::empty<f32>(shape, option);
//             noa::xform::draw({}, result, ellipse.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(result, asset, 5e-5));
//
//             // Apply the shape onto the input, in-place.
//             const auto data = noa::random(noa::Uniform{-10.f, 10.f}, shape, option);
//             noa::ewise(noa::wrap(result, data), result, noa::Multiply{});
//             noa::xform::draw(data, data, ellipse.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(result, data, 5e-4));
//
//             // Apply the shape onto the input, in-place, invert.
//             noa::randomize(noa::Uniform{-10.f, 10.f}, data);
//             noa::ewise(noa::wrap(data, asset), asset, ApplyInvertedMask{static_cast<f32>(cvalue)});
//             noa::xform::draw(data, data, inverted_ellipse.get(), inv_matrix);
...
//         if constexpr (COMPUTE_ASSETS) {
//             const auto asset = noa::empty<f32>(shape);
//             noa::xform::draw({}, asset, sphere.get());
//             noa::write_image(asset, filename_expected);
//             continue;
//         }
//
...
//             // Save shape into the output.
//             const auto result = noa::empty<f32>(shape, option);
//             noa::xform::draw({}, result, sphere.get());
//             REQUIRE(test::allclose_abs(result, asset, 5e-5));
//
//             // Apply the shape onto the input, in-place.
//             const auto data = noa::random(noa::Uniform{-10.f, 10.f}, shape, option);
//             noa::ewise(noa::wrap(result, data), result, noa::Multiply{});
//             noa::xform::draw(data, data, sphere.get());
//             REQUIRE(test::allclose_abs(result, data, 5e-5));
//
//             // Apply the shape onto the input, in-place, invert.
//             noa::randomize(noa::Uniform{-10.f, 10.f}, data);
//             noa::ewise(noa::wrap(data, asset), asset, ApplyInvertedMask{static_cast<f32>(cvalue)});
//             noa::xform::draw(data, data, inverted_sphere.get());
//             REQUIRE(test::allclose_abs(asset, data, 5e-5));
//         }
//     }
// }
...
//         if constexpr (COMPUTE_ASSETS) {
//             const auto asset = noa::empty<f32>(shape);
//             noa::xform::draw({}, asset, cylinder.get(), inv_matrix);
//             noa::write_image(asset, filename_expected);
//             continue;
//         }
//
...
//             // Save shape into the output.
//             const auto result = noa::empty<f32>(shape, option);
//             noa::xform::draw({}, result, cylinder.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(result, asset, 5e-5));
//
//             // Apply the shape onto the input, in-place.
//             const auto data = noa::random(noa::Uniform{-10.f, 10.f}, shape, option);
//             noa::ewise(noa::wrap(result, data), result, noa::Multiply{});
//             noa::xform::draw(data, data, cylinder.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(result, data, 5e-5));
//
//             // Apply the shape onto the input, in-place, invert.
//             noa::randomize(noa::Uniform{-10.f, 10.f}, data);
//             noa::ewise(noa::wrap(data, asset), asset, ApplyInvertedMask{static_cast<f32>(cvalue)});
//             noa::xform::draw(data, data, inverted_cylinder.get(), inv_matrix);
//             REQUIRE(test::allclose_abs(asset, data, 5e-5));
//         }
//     }
// }
...
//         };
//
//         noa::xform::draw(input, output_2d, sphere_2d.get(), inv_transform_2d);
//         noa::xform::draw(input, output_3d, sphere_3d.get(), inv_transform_3d);
...
//         };
//
//         noa::xform::draw(input, output_2d, rectangle_2d.get(), inv_transform_2d);
//         noa::xform::draw(input, output_3d, rectangle_3d.get(), inv_transform_3d);
//         REQUIRE(test::allclose_abs(output_2d, output_3d, 1e-4));
//     }
// }
//
...
//         };
//
//         noa::xform::draw(input, output_2d, ellipse_2d.get(), inv_transform_2d);
//         noa::xform::draw(input, output_3d, ellipse_3d.get(), inv_transform_3d);
//         REQUIRE(test::allclose_abs(output_2d, output_3d, 1e-4));
//     }
// }
//
...
//
//         noa::xform::draw(input, output_linear, ellipse.get(), inv_matrix_linear);
//         noa::xform::draw(input, output_affine, ellipse.get(), inv_matrix_affine);
...
//             const auto ellipse = noa::xform::Ellipse{center, radius, smoothness};
//             for (i64 i = 0; i < shape[0]; ++i)
//                 noa::xform::draw({}, serial.subregion(i), ellipse.get(), matrices.span_1d()[i]);
//             noa::xform::draw({}, batched, ellipse.get(), matrices_device);
//             REQUIRE(test::allclose_abs_safe(batched, serial, 1e-6));
//         }
//
//         AND_THEN("sphere") {
...
//             for (i64 i = 0; i < shape[0]; ++i)
//                 noa::xform::draw({}, serial.subregion(i), sphere.get(), matrices.span_1d()[i]);
//             noa::xform::draw({}, batched, sphere.get(), matrices_device);
//             REQUIRE(test::allclose_abs_safe(batched, serial, 1e-6));
//         }
//
//         AND_THEN("rectangle") {
//             const auto rectangle = noa::xform::Rectangle{center, radius, smoothness};
//             for (i64 i = 0; i < shape[0]; ++i)
//                 noa::xform::draw({}, serial.subregion(i), rectangle.get(), matrices.span_1d()[i]);
//             noa::xform::draw({}, batched, rectangle.get(), matrices_device);
//             REQUIRE(test::allclose_abs_safe(batched, serial, 1e-6));
//         }
//
//         AND_THEN("cylinder") {
...
//             for (i64 i = 0; i < shape[0]; ++i)
//                 noa::xform::draw({}, serial.subregion(i), cylinder.get(), matrices.span_1d()[i]);
//             noa::xform::draw({}, batched, cylinder.get(), matrices_device);
//             REQUIRE(test::allclose_abs_safe(batched, serial, 1e-6));
//         }
//     }
// }
...
//
//     noa::xform::draw({}, array, noa::xform::Ellipse{.center=Vec{32., 32.}, .radius=Vec{0., 0.}}.get_binary());
//     REQUIRE(noa::allclose(noa::sum(array), 1.));
//     noa::xform::draw({}, array, noa::xform::Ellipse{.center=Vec{32., 32.}, .radius=Vec{0., 0.}}.get());
//     REQUIRE(noa::allclose(noa::sum(array), 1.));
//
//     noa::xform::draw({}, array, noa::xform::Sphere{.center=Vec{32., 32.}, .radius=0.}.get_binary());
//     REQUIRE(noa::allclose(noa::sum(array), 1.));
//     noa::xform::draw({}, array, noa::xform::Sphere{.center=Vec{32., 32.}, .radius=0.}.get());
//     REQUIRE(noa::allclose(noa::sum(array), 1.));
//
//     noa::xform::draw({}, array, noa::xform::Rectangle{.center=Vec{32., 32.}, .radius=Vec{0., 0.}}.get_binary());
//     REQUIRE(noa::allclose(noa::sum(array), 1.));
//     noa::xform::draw({}, array, noa::xform::Rectangle{.center=Vec{32., 32.}, .radius=Vec{0., 0.}}.get());
//     REQUIRE(noa::allclose(noa::sum(array), 1.));
// }
