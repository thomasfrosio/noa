...
TEST_CASE("runtime::cpu::reduce_axes_iwise - 4d") {
    struct SumOp {
...
TEST_CASE("runtime::cpu::reduce_axes_iwise - 3d") {
    struct SumOp {
...
TEST_CASE("runtime::cpu::reduce_axes_iwise - 2d") {
    struct SumOp {
...
TEST_CASE("runtime::cpu::reduce_axes_iwise - 1d") {
    struct SumOp {
