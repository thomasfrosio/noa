...
namespace {
    ...
    void CPU_fft_lowpass_inplace(benchmark::State& state) {
        ...
        for (auto _: state) {
            ...
            cpu::fft::lowpass<fft::H2H, T>(input_result.get(), pitch,
...
BENCHMARK_TEMPLATE(CPU_fft_lowpass_inplace, half_t)->DenseRange(0, 5)->Unit(benchmark::kMillisecond)->UseRealTime();
BENCHMARK_TEMPLATE(CPU_fft_lowpass_inplace, float)->DenseRange(0, 5)->Unit(benchmark::kMillisecond)->UseRealTime();
BENCHMARK_TEMPLATE(CPU_fft_lowpass_inplace, chalf_t)->DenseRange(0, 5)->Unit(benchmark::kMillisecond)->UseRealTime();
BENCHMARK_TEMPLATE(CPU_fft_lowpass_inplace, cfloat_t)->DenseRange(0, 5)->Unit(benchmark::kMillisecond)->UseRealTime();

BENCHMARK_TEMPLATE(CPU_fft_lowpass, half_t)->DenseRange(0, 5)->Unit(benchmark::kMillisecond)->UseRealTime();
BENCHMARK_TEMPLATE(CPU_fft_lowpass, float)->DenseRange(0, 5)->Unit(benchmark::kMillisecond)->UseRealTime();
BENCHMARK_TEMPLATE(CPU_fft_lowpass, double)->DenseRange(0, 5)->Unit(benchmark::kMillisecond)->UseRealTime();
